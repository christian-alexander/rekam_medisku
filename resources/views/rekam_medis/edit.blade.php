...
<div class="container mt-3">
  <div class="card mb-4">
    ...
    <div class="card-body pb-2">
      ...
      <form action="/rekam_medis/{{ $rekam_medis->id }}" method='POST' id='form_tambah' onsubmit="return cek_panjang_teks('edit')" class='dont_disabled'>
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
          ...
          <div class="position-relative">
            <input type="date" class="form-control" name="tanggal" value="{{ $rekam_medis->tanggal }}" required>
          </div>
        </div>
