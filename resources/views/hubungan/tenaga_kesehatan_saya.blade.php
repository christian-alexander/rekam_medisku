            ...
            <tbody>
              ...
              @foreach ($tenaga_kesehatans_saya as $tenaga_kesehatan_saya)                  
                <tr>
                  ...
                  <td>
                    <div style='display:flex;'>
                      <div style='margin:0 auto;'>
                        <img src="{{ ($tenaga_kesehatan_saya->foto_profil == 'assets/img/avatars/user.png')? asset($tenaga_kesehatan_saya->foto_profil) : asset('storage/'.$tenaga_kesehatan_saya->foto_profil) }}" alt="user-avatar" class="d-block rounded" height="100" width="100">
                      </div>
                    </div>
                  </td>
                  ...
                  <td style="text-align: center;">
                    <button id='btn_putuskan_hubungan' style='border:0;background-color:rgba(0,0,0,0);visibility:visible;' onclick='putuskan_hubungan({{ $tenaga_kesehatan_saya->id }})'>
