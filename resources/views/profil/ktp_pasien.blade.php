    ...
    <form action="/ktp_pasien/{{ $ktp_pasien->id }}" method="POST">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" name="tempat_lahir" class='form-control' value='{{ $ktp_pasien->tempat_lahir }}' required>
        </div>

        <div class="form-group col-md-6">
          <label class='form-label'> Tanggal Lahir*</label>
          <input type="date" name="tanggal_lahir" class='form-control' value='{{ $ktp_pasien->tanggal_lahir }}' required>
        </div>

        <div class="form-group col-md-6">
          <label class='form-label'> Jenis Kelamin*</label>
          <select name="jenis_kelamin" class='form-control' required>
            <option value="1" {{ ($ktp_pasien->jenis_kelamin == 1)? 'selected' : '' }}>Laki Laki</option>
            <option value="2" {{ ($ktp_pasien->jenis_kelamin == 2)? 'selected' : '' }}>Perempuan</option>
          </select>
        </div>
        ...
        <div class="form-group col-md-6">
          ...
          <select name="status_perkawinan" class='form-control' required>
            <option value="1" {{ ($ktp_pasien->status_perkawinan == 1)? 'selected' : '' }}>Belum Kawin</option>
            <option value="2" {{ ($ktp_pasien->status_perkawinan == 2)? 'selected' : '' }}>Kawin</option>
            <option value="3" {{ ($ktp_pasien->status_perkawinan == 3)? 'selected' : '' }}>Cerai Hidup</option>
            <option value="4" {{ ($ktp_pasien->status_perkawinan == 4)? 'selected' : '' }}>Cerai Mati</option>
          </select>
        </div>
        ...
        <div class="form-group col-md-6">
          ...
          <select name="golongan_darah" class='form-control' required>
            <option value="0" {{ ($ktp_pasien->golongan_darah == 0)? 'selected' : '' }}>Tidak Tahu</option>
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" name="alamat" class='form-control' value='{{ $ktp_pasien->alamat }}' required>
        </div>

        <div class="form-group col-md-6">
          <label class='form-label'> Pekerjaan*</label>
          <input type="text" name="pekerjaan" class='form-control' value='{{ $ktp_pasien->pekerjaan }}' required>
        </div>
