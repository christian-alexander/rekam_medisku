        ...
        <tbody>
          @foreach ($asuransi_pasiens as $asuransi_pasien)
            ...
            <tr>
              ...
              <td style="text-align: center;">
                <button id='btn_edit' style='border:0;background-color:rgba(0,0,0,0);visibility:visible;' onclick='edit_asuransi({{ $asuransi_pasien->id }})'>
                  <i class='fa fa-pencil' style='color:#3c8dbc;'></i>
                </button>
              </td>

              <td style="text-align: center;">
                <button id='btn_hapus' style='border:0;background-color:rgba(0,0,0,0);visibility:visible;' onclick='hapus_asuransi({{ $asuransi_pasien->id }})'>
        ...
        <form action="/asuransi_pasien" method='POST' id='form_tambah'>
          ...
          <div class="mb-3">
            ...
            <div class="position-relative">
              <input type="text" required class="form-control" name="penyedia" placeholder="Contoh : Prudential, BPJS">
            </div>
          </div>
      ...
      <div class="modal-body">
        <form action="diisi_dari_js" method='POST' id='form_edit_asuransi'>
          ...
          <div class="mb-3">
            <label class="form-label">Penyedia Asuransi*</label>
            <div class="position-relative">
              <input type="text" required class="form-control" name="penyedia" id="penyedia_edit" placeholder="Contoh : Prudential, BPJS">
            </div>
          </div>
          ...
          <div class="mb-3">
            <label class="form-label">Nomor Polis*</label>
            <div class="position-relative">
              <input type="text" required class="form-control" name="nomor_polis" id="nomor_polis_edit">
            </div>
          </div>
          ...
          <div class="mb-3">
            <label class="form-label">No Telepon Penyedia Asuransi*</label>
            <div class="position-relative">
              <input type="text" required class="form-control" name="no_telepon" id="no_telepon_edit">
            </div>
          </div>
